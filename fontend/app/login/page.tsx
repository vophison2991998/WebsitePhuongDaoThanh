...
import LoginForm from "./LoginForm"; // Đã sửa đường dẫn import phù hợp với cấu trúc file .js của bạn
...
export default function LoginPage() {
  ...
  useEffect(() => {
    // Cập nhật thời gian thực theo định dạng hành chính Việt Nam
    ...
    // Thông báo hệ thống khi trang tải xong
    if (!shown.current) {
      toast.showToast("Cổng thông tin xác thực nội bộ sẵn sàng", "info");
      shown.current = true;
    }
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F2F4F7] font-sans antialiased text-slate-900">
      ...
      {/* 1. TOP HEADER - THÔNG BÁO & THỜI GIAN */}
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center uppercase tracking-wider">
          <div className="flex items-center gap-4">
            <span className="flex items-center gap-1.5 animate-pulse">
              <Bell size={12} /> Thông báo: Hệ thống giám sát an ninh đang hoạt động
            </span>
          </div>
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[11px] md:text-xs font-bold text-slate-600 uppercase tracking-[2px] mt-1">
                Ủy ban nhân dân Phường Đạo Thạnh
              </p>
            </div>
          </div>
          ...
          <div className="hidden lg:flex items-center gap-6">
            <div className="text-right">
              <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Hỗ trợ kỹ thuật</p>
      ...
      {/* 3. KHÔNG GIAN ĐĂNG NHẬP */}
      <main className="flex-1 relative flex items-center justify-center p-6 lg:p-12 overflow-hidden bg-slate-50">
        
        {/* Họa tiết chìm (Trống Đồng / Landmark) */}
        <div className="absolute inset-0 z-0 flex items-center justify-center opacity-[0.03] pointer-events-none">
          <Landmark size={600} strokeWidth={0.5} />
        </div>

        <div className="relative z-10 w-full max-w-5xl flex flex-col md:flex-row bg-white rounded-2xl shadow-[0_20px_60px_rgba(0,0,0,0.1)] overflow-hidden border border-slate-200">
          
          {/* CỘT TRÁI: TUYÊN NGÔN BẢO MẬT */}
          <div className="flex-1 bg-[#1e293b] p-10 lg:p-14 flex flex-col justify-between relative">
            ...
            <div className="relative z-10">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-red-600/20 rounded text-red-400 text-[10px] font-black uppercase tracking-widest mb-8 border border-red-600/30">
                <ShieldCheck size={12} /> Chứng chỉ an toàn quốc gia
              </div>
              ...
              <ul className="space-y-5">
                {[
                  ...
                  "Nhật ký thao tác thời gian thực"
                ].map((item, i) => (
            ...
            <div className="relative z-10 pt-10 border-t border-slate-700 flex items-center gap-4 text-slate-500">
              ...
              <p className="text-[10px] font-medium leading-relaxed italic uppercase tracking-tighter">
                Tuân thủ Nghị định số 13/2023/NĐ-CP <br /> về bảo mật dữ liệu hành chính công.
              </p>
            </div>
          </div>
            ...
            <div className="max-w-sm mx-auto w-full">
              <div className="text-center md:text-left mb-10">
                ...
                <p className="text-slate-500 text-xs font-bold flex items-center justify-center md:justify-start gap-2 uppercase tracking-wide">
                  <Lock size={12} className="text-red-700" /> Cổng xác thực tập trung SSO
                </p>
              </div>

              {/* FORM XỬ LÝ (LoginForm.js) */}
              <LoginForm />
      ...
      <footer className="w-full bg-white border-t border-slate-200 py-8 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-center md:text-left text-slate-600">
            ...
            <p className="text-[11px] opacity-70 mt-1 italic font-medium">Trung tâm Chuyển đổi số nội bộ thực hiện.</p>
          </div>
          <div className="flex gap-6 text-[10px] text-slate-500 uppercase tracking-widest font-bold">
            <a href="#" className="hover:text-red-700 underline underline-offset-4">Chính sách an toàn</a>
            <a href="#" className="hover:text-red-700 underline underline-offset-4">Liên hệ hỗ trợ</a>
          </div>
        </div>
      </footer>
    </div>
